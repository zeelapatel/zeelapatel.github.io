...
function arter_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'		=> 'arter-plugin',
			'source'	=> ARTER_EXTRA_PLUGINS_DIRECTORY . 'normal/arter-plugin/110923/' . 'arter-plugin.zip',
			'required'	=> true,
			'version'	=> '1.6.6',
		),
	...
	if ( class_exists( 'ArterPlugin' ) ) {
		$plugins[] = array(
			...
			'source'				=> ARTER_EXTRA_PLUGINS_DIRECTORY . '/normal/acf/110923/' . 'advanced-custom-fields-pro.zip',
			'required'				=> true,
			'version'				=> '6.2.1.1',
		);
	}
