...
if( ! class_exists( 'acf_field_arter_cf7' ) ) :

class acf_field_arter_cf7 extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __( 'Contact Form 7', 'arter-plugin' );
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __( 'Allow Null?', 'arter-plugin' ),
			'type'			=> 'radio',
			'name'			=> 'allow_null',
			'choices' =>  array(
			  	1 =>  __( 'Yes', 'arter-plugin' ),
			  	0 =>  __( 'No', 'arter-plugin' ),
			),
			'layout'  =>  'horizontal'
		));

		acf_render_field_setting( $field, array(
			'label'			=> __( 'Select Multiple?', 'arter-plugin' ),
			'type'			=> 'radio',
			'name'			=> 'multiple',
			'choices' =>  array(
				1 =>  __( 'Yes', 'arter-plugin' ),
		...
		acf_render_field_setting( $field, array(
			'label'			=> __( 'Disable Forms?', 'arter-plugin' ),
			'instructions'	=> __( 'User will not be able to select these forms', 'arter-plugin' ),
			'type'			=> 'select',
			'name'			=> 'disable',
			'multiple'		=> '1',
			'allow_null'  =>  '0',
